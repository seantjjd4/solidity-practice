...
contract Company{
    ...
    function add_performance(string memory salesman , uint256 profit) public {
        name_to_sales[salesman].performance += profit;
        name_to_sales[salesman].salary += profit/10;
    }
    
    function add_sales(string memory salesman , address payable sales_address ) public {
